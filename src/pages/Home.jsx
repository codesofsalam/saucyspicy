    ...
    Learn More <ChevronRight size={20} />
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Our Favorites</h2>
          <div className="grid md:grid-cols-2 gap-12">
            ...
            {/* Drinks Menu */}
            <div className="space-y-8">
              <h3 className="text-2xl font-semibold text-center mb-8">Drinks</h3>
              <div className="space-y-6">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-600">123 Restaurant Street, Foodville</span>
              </div>
              <div className="flex items-center gap-4">
                <Clock className="text-orange-600" />
                <span className="text-gray-600">Mon-Sun: 9:00 AM - 11:00 PM</span>
              </div>
            </div>
          </div>
          <div className="lg:w-1/2">
